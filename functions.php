...
add_action('wp_enqueue_scripts', 'markmurphy_scripts', 100);
function markmurphy_scripts(){
  wp_register_script(
    'bootstrap-script', 
  ...
  wp_register_script(
    'markmurphy-scripts', 
    get_template_directory_uri() . '/js/markmurphy-scripts.js', 
    array('jquery'), 
    '', 
    true
  );
  ...
  wp_enqueue_script('markmurphy-scripts');  
}

add_action('wp_enqueue_scripts', 'markmurphy_styles');
function markmurphy_styles(){
  wp_register_style('bootstrap-css', '//maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css');
	wp_register_style('google-fonts', '//fonts.googleapis.com/css?family=Assistant:700');
  wp_register_style('markmurphy', get_template_directory_uri() . '/style.css');
...
function markmurphy_fallback_header_menu(){ ?>
  <div id="navbar" class="navbar-collapse collapse">
    <ul class="nav nav-justified">
      ...
      <li<?php if(is_page('testimonials')){ echo ' class="active"'; } ?>><a href="<?php echo home_url('testimonials'); ?>" title="Testimonials">Testimonials</a></li>
      <li<?php if(is_page('about')){ echo ' class="active"'; } ?>><a href="<?php echo home_url('about'); ?>" title="About">About</a></li>
      <li<?php if(is_page('practice')){ echo ' class="active"'; } ?>><a href="<?php echo home_url('practice'); ?>" title="Practice">Practice</a></li>
      <li<?php if(is_page('news')){ echo ' class="active"'; } ?>><a href="<?php echo home_url('news'); ?>" title="News">News</a></li>
